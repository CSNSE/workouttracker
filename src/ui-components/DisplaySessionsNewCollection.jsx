...
import DisplaySessionsNew from "./DisplaySessionsNew";
...
export default function DisplaySessionsNewCollection(props) {
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "DisplaySessionsNewCollection")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {
