...
import BorderDispSessions from "./BorderDispSessions";
...
export default function BorderDispSessionsCollection(props) {
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "BorderDispSessionsCollection")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {
